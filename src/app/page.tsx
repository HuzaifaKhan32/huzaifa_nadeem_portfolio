...
import MobilePrePage from "./components/MobilePrePage";
...
export default function Home() {
  ...
  return (
    <>
      <div className={`${entered ? 'hidden' : 'block'} md:hidden`}>
        <MobilePrePage onEnter={() => setEntered(true)} />
      </div>

      <div className={`${entered ? 'block' : 'hidden'} md:block`}>
